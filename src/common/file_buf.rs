...
impl<'a> Bytes<usize> for FileVolatileSlice<'a> {
    ...
    fn read_volatile_from<F>(&self, addr: usize, src: &mut F, count: usize) -> Result<usize, Self::E>
    where
        F: ReadVolatile,
    {
        #[allow(deprecated)]
    ...
    fn read_exact_volatile_from<F>(&self, addr: usize, src: &mut F, count: usize) -> Result<(), Self::E>
    where
        F: ReadVolatile,
    {
        #[allow(deprecated)]
    ...
    fn write_all_volatile_to<F>(&self, addr: usize, dst: &mut F, count: usize) -> Result<(), Self::E>
    where
        F: WriteVolatile,
    {
        #[allow(deprecated)]
